...
-(NSArray*)FilePathOfSendingImage:(NSString*)filepath parameterOne:(NSString*)parameterOne parameterTwo:(NSString*)parameterTwo parameterThree:(NSString*)parameterThree parameterFour:(NSString*)parameterFour{
    ...
    NSArray *responseArray = [self FilePath:filepath parameterOne:parameterOne parameterTwo:parameterTwo parameterThree:parameterThree parameterFour:parameterFour];
    return responseArray;
...
-(NSArray*)FilePath:(NSString*)filepath parameterOne:(NSString*)parameterOne parameterTwo:(NSString*)parameterTwo parameterThree:(NSString*)parameterThree parameterFour:(NSString *)parameterFour
{
    ...
    NSString *myRequestString = [NSString stringWithFormat:@"image=%@&user_id=%@&property_id=%@&image_type=%@",parameterOne,parameterTwo,parameterThree,parameterFour];
